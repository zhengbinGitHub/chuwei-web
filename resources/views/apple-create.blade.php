                    ...
                    <div class="G-voucher-main">
                        @forelse($lists as $key=>$item)
                            <div class="layui-form-item credentials" data-id="{{$key}}">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" value="{{$item->app_id}}" class="layui-input col-xs-2" placeholder="请输入应用AppID" lay-verify="required" name="apps[{{$key}}][app_id]">
                                    <input type="text" value="{{$item->app_secret}}" class="layui-input col-xs-2" placeholder="请输入应用AppSecret" style="margin-left:10px;" name="apps[{{$key}}][app_secret]">
                        ...
                        @empty
                            <div class="layui-form-item credentials" data-id="0">
                                <label for="" class="layui-form-label"></label>
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input col-xs-2" placeholder="请输入应用AppID" lay-verify="required" name="apps[0][app_id]">
                                    <input type="text" class="layui-input col-xs-2" placeholder="请输入应用AppSecret" style="margin-left:10px;" name="apps[0][app_secret]">
